...
class SportsFragment : Fragment(R.layout.fragment_sports) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sports_rec_view.adapter = adapter
        //sports_rec_view.layoutManager = LinearLayoutManager(view.context)
        ...
        manager.setItemChangedListener(object: StackLayoutManager.ItemChangedListener{
            override fun onItemChanged(position: Int) {
                ...
                sports_container.setBackgroundColor(Color.parseColor(colour))
        ...
        sports_rec_view.layoutManager = manager
        getNews()
    }

    private fun getNews() {
        val news = NewsServices.newsInstance.getHeadlines("in", "sports",pageNum)
