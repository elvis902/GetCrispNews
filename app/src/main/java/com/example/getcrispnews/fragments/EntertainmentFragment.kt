...
class EntertainmentFragment : Fragment(R.layout.fragment_entertainment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        entertainment_rec_view.adapter = adapter
        //entertainment_rec_view.layoutManager = LinearLayoutManager(view.context)
        ...
        manager.setItemChangedListener(object: StackLayoutManager.ItemChangedListener{
            override fun onItemChanged(position: Int) {
                ...
                entertainment_container.setBackgroundColor(Color.parseColor(colour))
        ...
        entertainment_rec_view.layoutManager = manager
        getNews()
    }

    private fun getNews() {
        val news = NewsServices.newsInstance.getHeadlines("in", "entertainment",pageNum)
