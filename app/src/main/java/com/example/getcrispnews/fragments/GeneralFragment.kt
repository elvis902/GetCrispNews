...
class GeneralFragment : Fragment(R.layout.fragment_general) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        general_rec_view.adapter = adapter
        //general_rec_view.layoutManager = LinearLayoutManager(view.context)
        ...
        manager.setItemChangedListener(object: StackLayoutManager.ItemChangedListener{
            override fun onItemChanged(position: Int) {
                ...
                general_container.setBackgroundColor(Color.parseColor(colour))
        ...
        general_rec_view.layoutManager = manager
        getNews()
    }

    private fun getNews() {
        val news = NewsServices.newsInstance.getHeadlines("in", "general",pageNum)
